...
<Frame caption="Placeholder — screenshot: the side panel showing the Info tab beside a terminal">
  <img src="/images/placeholder.svg" alt="The osiris side panel" />
</Frame>

## Info

Everything osiris knows about the focused pane, in one column:
...
where" — the same data `oexe procs` prints. A port row copies `localhost:PORT`,
