...
The left sidebar is osiris's tab bar, and it is the default because a vertical row
...
<Frame caption="Placeholder — screenshot: the sidebar with two repo groups, agent avatars and status dots, branch and +N −M counts">
  <img src="/images/placeholder.svg" alt="The osiris tab sidebar" />
</Frame>
...
`oexe tab ls` answers the same question with more evidence, because a script has
