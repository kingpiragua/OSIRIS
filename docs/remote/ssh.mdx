...
osiris speaks SSH itself, over [russh](https://github.com/Eugeny/russh). It never
...
<Frame caption="Placeholder — screenshot: an SSH connection sheet asking for a key passphrase inside a pane">
  <img src="/images/placeholder.svg" alt="Connecting over SSH in osiris" />
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="An alias from ~/.ssh/config">
    Type an alias you already have and osiris resolves it natively — common fields,
