...
<Frame>
  <img src="/images/hero.webp" alt="osiris showing a sidebar of agent sessions across several repositories" />
</Frame>

osiris is a terminal you can leave running. Close the window, reboot the machine,
...
<CardGroup cols={2}>
  <Card title="Sessions that outlive the app" icon="power-off" href="/getting-started/concepts">
    A background server owns your shells, not the window. Quit osiris and your
  ...
  <Card title="Scriptable" icon="terminal" href="/cli/overview">
    A bundled `osiris` CLI that opens panes, sends keys, reads screens, and blocks
...
| | **osiris** | Alacritty | Ghostty | Kitty |
|---|---:|---:|---:|---:|
...
[`scripts/bench/`](https://github.com/kingpiragua/osiris/tree/main/scripts/bench).
...
<CardGroup cols={3}>
    <Card title="Issues" icon="github" href="https://github.com/kingpiragua/osiris/issues">
    Bugs and feature requests.
  </Card>
  <Card title="Changelog" icon="list" href="https://github.com/kingpiragua/osiris/blob/main/CHANGELOG.md">
