---
title: "Updates"
description: "How osiris updates itself, and what the two channels mean."
---
...
<Steps>
  <Step title="Check">
    osiris checks at launch and every six hours after that. Turn it off entirely
  ...
  <Step title="Update and relaunch">
    A dedicated `osiris-updater` helper verifies the release checksum, the bundle
...
If Settings tells you this, osiris was updated in place: the app is the new build,
