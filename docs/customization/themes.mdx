...
<Frame caption="Placeholder — screenshot: the theme picker with light and dark sections">
  <img src="/images/placeholder.svg" alt="The osiris theme picker" />
</Frame>

## Following the system

Turn on **Sync with system** and pick a theme for each appearance. osiris follows
...
| | |
|---|---|
| macOS / Linux | `~/.config/osiris/themes/` |
| Windows | `%APPDATA%\osiris\themes\` |
...
Drop an `.itermcolors` file into the themes folder and osiris reads it directly —
no conversion step.

<Note>
  A theme file osiris could not load is listed in Settings under **Not loaded from
