...
across two lines — osiris stitches it back together before opening it.
...
opens in osiris's own editor, on the line the link named, and the Files panel
...
| Mode | Opens in |
| --- | --- |
| Built-in editor | osiris's editor, at `:line:column`. The default. |
...
and osiris opens a temporary port forward through that connection first, so the
