...
That releases <kbd>⌃ R</kbd> and nothing else — <kbd>↑</kbd> still walks osiris's
...
history written outside osiris shows up immediately.

The per-row extras — when you last ran it, whether it failed — come from a small
file osiris keeps alongside it, filled in as you run things. A command osiris has
