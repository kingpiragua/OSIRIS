...
//! — see [`osiris_core::core::kitty_graphics`]). This module is the client end: it
...
use osiris_core::core::kitty_graphics::{Image, ImageDelete, WireFormat};
...
impl ImageStore {
    ...
    /// Apply a delete selector. Only the targets a sender osiris faces actually
...
const MAX_PENDING_BYTES: usize = osiris_core::core::kitty_graphics::MAX_IMAGE_BYTES;
...
impl DecodeWorker {
    ...
    fn spawn_with_decoder(
        ...
        let handle = std::thread::Builder::new()
            .name("osiris-image-decode".to_string())
