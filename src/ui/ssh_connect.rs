...
use super::app::{SpawnAs, SpawnWhere, OsirisApp};
...
fn build_spec_inner(
    ...
    NativeSshSpec {
        ...
        // what left ad-hoc connections all sharing the name "osiris" (#438).
...
mod tests {
    ...
    /// of them opened a tab called "osiris".
    #[test]
