...
impl CommandKind {
    ...
    pub fn id(&self) -> Option<&'static str> {
        ...
        Some(match self {
            ...
            OpenDiscord => "discord osirisexe archive site",
...
impl Command {
    ...
    pub fn base_commands(cx: &App, chrome: ChromeState) -> Vec<Command> {
        ...
        let application = [
            ...
            Command::localized(L10nKey::CmdAboutOsiris, About),
            ...
            Command::localized(L10nKey::CmdQuitOsiris, Quit)
                .with_subtitle(t(L10nKey::CmdQuitOsirisSubtitle)),
        ];
