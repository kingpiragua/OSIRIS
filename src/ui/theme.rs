...
pub(crate) fn set_menus(cx: &mut App) {
    cx.set_menus([
        ...
        Menu::new(t(L10nKey::AppMenuFile)).items([
            ...
            MenuItem::separator(),
            // SSH is one of the reasons to pick osiris and it had no entry in the
...
pub(crate) fn apply_theme(mut window: Option<&mut Window>, cx: &mut App) {
    ...
    // OSC 11 background query before osiris's emulator can answer it. Derived
