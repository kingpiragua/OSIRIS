...
use osiris_core::core::git::ops::{Destructive, GitOp, PullMode};
...
fn discard_all_ops(status: &osiris_core::core::git::status::WorkingTreeStatus) -> Vec<GitOp> {
