...
/// A keyword the file sets for a host osiris is importing, that no `SshProfile`
...
pub struct ImportReport {
    ...
    /// out here that osiris never opened it.
...
/// an edit made outside osiris is seen on the first tick after the file
...
/// blocks that name at least one host osiris is actually importing.
///
...
/// anyone's host; it is a line about hosts osiris was never asked to import.
