...
/// handle inheritance follow *that* process, not osiris, so a handle from our
...
///
/// The actual caller remains osiris, but Windows derives the child token, device
...
mod tests {
    ...
    fn arguments_survive_the_crt_quoting_rules() {
        ...
        assert_eq!(quoted(""), r#""""#);
        assert_eq!(quoted(r"C:\Users\me\osiris"), r#""C:\Users\me\osiris""#);
