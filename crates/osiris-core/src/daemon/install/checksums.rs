...
mod tests {
    ...
    fn a_malformed_entry_aborts() {
        for bad in [
            "abc  osiris-server-linux-x86_64-musl",
            "zz786850e387550fdab836ed7e6dc881de23001b4b4d8ec3a1a0b9d5e0d5c0f1x  osiris-server-linux-x86_64-musl",
            "  osiris-server-linux-x86_64-musl",
        ] {
