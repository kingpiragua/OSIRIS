...
impl HttpsFetcher {
    pub fn new(manual_proxy: Option<&str>) -> Self {
        let mut builder = ureq::Agent::config_builder()
            ...
            .user_agent(concat!("osiris/", env!("CARGO_PKG_VERSION")));
...
mod tests {
    ...
    fn talks_to_github() {
        ...
        let bytes = fetcher
            .get("https://github.com/kingpiragua/osiris/raw/main/README.md")
        ...
        let missing = super::super::asset::download_url("v0.0.0-never", "osiris-server-nope");
        let err = fetcher
            .get(&missing)
