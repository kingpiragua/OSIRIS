...
pub const SERVICE_PASSWORD: &str = "osiris-ssh";
pub const SERVICE_KEY_PASSPHRASE: &str = "osiris-ssh-key";
...
mod tests {
    ...
    fn credential_kind_selects_service() {
        assert_eq!(CredentialKind::Password.service(), "osiris-ssh");
        assert_eq!(CredentialKind::KeyPassphrase.service(), "osiris-ssh-key");
    }
