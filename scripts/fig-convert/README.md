# fig-convert — Fig autocomplete specs → osiris completion signatures

osiris's per-command completion (flags/subcommands/args with descriptions) is
...
# 2. Convert the commands osiris embeds into assets/completions/.
